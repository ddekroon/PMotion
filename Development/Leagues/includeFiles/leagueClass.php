...
class League
{
	...
	public $leagueFullTeams, $leagueFullMales, $leagueFullFemales, $leagueSportName, $leagueCost;
  	...
  	public function _Construct()
  	{
		...
		$this->leagueFullTeams = 0;
		$this->leagueFullMales = 0;
		$this->leagueFullFemales = 0;
		$this->leagueCost = 0;
