...
function printSeasonEditor($seasonObj, $sports) { ?>
	...
	<?php } ?>
        ...
        <td>
            ...
            <!-- try moving "strtotime($seasonObj->seasonRegistrationDueBy" down to line 106 (after date_picker)-->
		</td>

        <!-- This is now set to always ON but also commented out incase minds are changed-->
        
        <td>
			<!--Registration Due By Sport -->
		</td> <td>
			<select id="regBySport" name='regBySportOn'>
