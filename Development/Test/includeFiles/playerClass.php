...
class Player
{
	public $playerID, $playerTeamID, $playerTeamName, $playerFirstName, $playerLastName, $playerEmail, $playerPhone, $playerGender, $playerLeagueID;
	public $playerGroupID, $playerGameDay, $playerLeagueName, $playerSportID, $playerIsCaptain, $playerHearText, $playerIsIndividual;	
