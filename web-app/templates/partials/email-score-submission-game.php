...
<table style="border: none; border-collapse: collapse; color: #494e52; margin: 0; padding: 0; vertical-align: top; width: 100%;">
	<tbody>
		<tr>
			...
			<td class="padding-left three-quarters" style="margin: 0; padding: 7px; padding-left: 20px; vertical-align: top; width: 75%;"><?php echo $submissions[$matchNum]->getOppTeam()->getName() ?></td>
		</tr>
