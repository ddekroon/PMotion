...
function reloadSport(self) {
	...
	document.location = 'finalizeLeague.php?sportID=' + self.value + '&seasonID=' + seasonID;
}

function reloadSeason(self) {
	var sportID = document.getElementsByName('sportID')[0].value;
	document.location = 'finalizeLeague.php?sportID=' + sportID + '&seasonID=' + self.value;
}

function reloadLeague(self) {
	var sportID = document.getElementsByName('sportID')[0].value;
	var seasonID = document.getElementsByName('seasonID')[0].value;
	document.location= 'finalizeLeague.php?sportID=' + sportID + '&seasonID=' + seasonID + '&leagueID=' + self.value;
}