...
class Player
{
	...
	public $playerGroupID, $playerGameDay, $playerLeagueName, $playerSportID, $playerLeagueID, $playerIsCaptain, $playerSportName, $playerIsIndividual, $playerTeamNum;	
