...
function checkTeamWeek() {
	var oldWeek = document.getElementById("teamWeek").value;
	var newWeekArray = document.getElementsByName('newTeamWeek');
	var newWeek = newWeekArray[0].value;
	return confirm("Are you sure you want to change the team week " + oldWeek + ' to ' + newWeek);
}
...
function reloadPageSport() {
	...
	self.location='editTeam.php?sportID=' + sportID;
}
...
function reloadPageLeague() {
	...
	self.location='editTeam.php?sportID=' + sportID + '&leagueID=' + leagueID;
}
...
function reloadPageTeam() {
	...
	self.location='editTeam.php?sportID=' + sportID + '&leagueID=' + leagueID+ '&teamID=' + teamID;
}