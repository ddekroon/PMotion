<?php
	...
	for($i=1;$i<9;$i++) {
		$personQuery = mysql_query("SELECT * FROM $playersTable INNER JOIN $teamsTable ON $teamsTable.team_id = $playersTable.player_team_id 
	...
	# -------  Define Colors ----------------
	$bar_color=imagecolorallocate($img, 77, 77, 0);
