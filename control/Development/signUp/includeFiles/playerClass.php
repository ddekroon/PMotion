...
class Player
{
	...
	public $playerGroupID, $playerGameDay, $playerLeagueName, $playerSportID, $playerLeagueID, $playerRating, $playerHearMethod, $playerHearOtherText;	
  	...
  	public function __construct()
  	{
		...
		$this->playerRating = 0;
		$this->playerHearMethod = 0;
		$this->playerHearOtherText = '';
  	}
