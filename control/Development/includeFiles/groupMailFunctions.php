...
function mailForm($playerArray, $groupComments, $sportName, $leagueID, $leagueNames, $payMethod){
	...
	$secondary = '<tr><td align=center>New Player(s) Registered for <B>'.$sportName.' - '.stripslashes($leagueNames[0]).'.</B></td></tr>';
	...
	sendEmails(array($playerArray[0]->playerEmail,),'info@perpetualmotion.org', $subject,  $message);
