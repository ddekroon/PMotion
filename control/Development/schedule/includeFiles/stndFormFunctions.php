	...
	<table class="titleBox">
		<tr>
			<th>
                ...
                <button type='Submit' style="width:25px;height:25px;" name='printit' value='Print Form' onclick='javascript:window.print();'><img src='printButton.png' style="width:30px;height:25px;"></button>
			</th>
		</tr><tr>
			<td align="center">
	...
	<table class='activeStandingsTable' style="width:90%;max-width:450px;">
		...
		if(count($teams) > 0) {
			...
			foreach($teams as $team) {
				if ($team->team_league_id == $leagueID) {						
