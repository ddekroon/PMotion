    ...
    <div class="Table" style="width:90%; max-width:525px; min-width:250px;" align="center">
		<div class="game" align="center" style="width:100%; max-width:525px; min-width:250px;">
			...
			<?php if ($oppTeamID[$i] != 1) { // otherwise it's a practise game
				for($j = 0; $j < $games; $j++){ ?>
					<div class="Row" align="center">
						<div class="Cell" style="width:30%; vertical-align:middle;">
                        ...
                        <div class="Cell" align="center">
							...
							if($scoresAvailable == 1 || $isPlayoffs == 1){ ?>
                                <div class="Row" align="center">
                                	<div class="noBorderCell">
                                        <div class="noBorderCell" align="right" style="vertical-align:middle;">
                                            Scores
                                        </div>
                                        <div class="noBorderCell">
                                            <div class="Row" align="center">
				...
				<div class="Row">
					<div class="Cell" style="vertical-align:middle;">Comments (optional):
					</div><div class="Cell">
