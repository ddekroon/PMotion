...
function loadDefaults($sportID) {
	...
	if($sportID == 1) {
		$formTitle='Submit Results - Guelph Ultimate League';
		$logo='/Logos/ultimate_0.png';
	} elseif($sportID == 2) {
		$formTitle='Submit Results - Guelph Beach Volleyball League';
		$logo='/Logos/volleyball_0.png';
	} elseif($sportID == 3) {
		$formTitle='Submit Results - Guelph Flag Football League';
		$logo='/Logos/football_0.png';
	} elseif($sportID == 4) {
		$formTitle='Submit Results - Guelph 6 vs 6 Soccer League';
		$logo= '/Logos/soccer_0.png';
	} else  {
		$formTitle='Submit Results - Perpetual Motion';
...
function getSubmittedData() {
	...
	for ($i=0;$i<$matches;$i++) {
		...
		if(($spiritScores[$i] = $_POST['spiritScore'][$i]) == 'N/A') {
			$spiritScores[$i] = 0;
		}
