...
function printJavaScript() { ?>
    <div class="Table" align="center" style="width:95%; max-width:425px; min-width:250px;">
        <div class="Row">
            <noscript>
...
function printTopInfo() {
    ...
    <div class="Table" align="center" style="width:95%; max-width:425px; min-width:250px;">
		...
		<div class="infoBox" align="center" style="width:100%; max-width:425px; min-width:250px;">
        	<div class="Row" align="center" style="text-align:center;">
        		<div class="Cell" align="center" style="vertical-align:middle;">
                	Game Information
                </div>
            </div>
            <div class="noBorderCell">
				<div class="Row" align="center">
                	<div class="left_column" style="vertical-align:middle;">
...
function printMatches() {
	...
	for ($i = 0; $i < $matches; $i++){ ?>
    <div class="Table" style="width:95%; max-width:525px; min-width:250px;" align="center">
		<div class="game" align="center" style="width:100%; max-width:525px; min-width:250px;">
			<div class="Row" align="center">
            	<div class="Cell" style="vertical-align:middle;">
			...
			<?php if ($oppTeamID[$i] != 1) { // otherwise it's a practise game
				...
				for($j = 0; $j < $games; $j++){ 
                    ...
                    <?php  } ?>
					<div class="Row" align="center">
						<div class="left_column" style="width:30%; vertical-align:middle;">
                        	Game <?php print $j + 1?> Results :
						</div>
                        <div class="Cell" align="center" style="vertical-align:middle;">
                        	<div class="Column" style="width:50%;" style="vertical-align:middle;">
                            	<label for="win">We Won</label>
								<?php if ($gameResults[$gameNum] == 1) {?>
                                    <INPUT TYPE='radio' id="win" checked name='results[<?php print $gameNum?>]' VALUE=1>
                                <?php } else { ?>
                                    <INPUT TYPE='radio' id="win" name='results[<?php print $gameNum?>]' VALUE=1>
                                <?php } ?>
                                
                                <br />
                                <br />
                                <label for="lost">We Lost</label>
								
                                 <?php if ($gameResults[$gameNum] == 2) {?>
                                 	
                                    <INPUT TYPE='radio' id="lost" checked name='results[<?php print $gameNum?>]' VALUE=2>
                                <?php } else { ?>

                                    <INPUT TYPE='radio' id="lost" name='results[<?php print $gameNum?>]' VALUE=2>
                                <?php } 
                                 if($hasTies == 1){ ?>
                                 	<br />
                                    <br />
                                 	<label for="tied">We Tied</label>
                                    <?php if ($gameResults[$gameNum] == 3) {?>
                                        <INPUT TYPE='radio' id="tied" checked name='results[<?php print $gameNum?>]' VALUE=3>
                                    <?php } else { ?>
                                        <INPUT TYPE='radio' id="tied" name='results[<?php print $gameNum?>]' VALUE=3>
                                    <?php } 
                                 }
                                if($showCancelOption == 1){ ?>
                                    ...
                                    <?php if ($gameResults[$gameNum] == 4) {?>
                                        <INPUT TYPE='radio' id="cancel" checked name='results[<?php print $gameNum?>]' VALUE=4>
                                    <?php } else { ?>
                                        <INPUT TYPE='radio' id="cancel" name='results[<?php print $gameNum?>]' VALUE=4>
                                    <?php }
                                } ?>
                            </div>  
                                	...
                                	<div class="noBorderCell">
                                        ...
                                        <div class="noBorderCell" align="center">
                                            ...
                                            <div class="Row" align="center">
                                                ...
                                                <div class="Column">
                                                <SELECT NAME='scoreus[]' style="width:100%; max-width:40px; min-width:40px;">
                                            ...
                                            <div class="Row" align="center">
                                                ...
                                                <div class="Column">
                                                    <SELECT NAME='scorethem[]' style="width:100%; max-width:40px; min-width:40px;">
					...
					<?php $gameNum++; 
                     ...
                     ?>
					<div class="Row">
						<div class="left_column">Spirit Score:
						</div>
                        <div class="Cell" style="vertical-align:middle;">
						<SELECT NAME='spiritScore[]' id="spiritMobile" style="width:30%; vertical-align:middle; display:none;">
                        <OPTION selected='selected' VALUE='N/A'>Spirit</OPTION>
						<?php //for loop, same as above 
                        for ($x=5; $x >= 1; $x-=.5){
                            if ($x == $scoreThem[$gameNum]) { ?>
                                <OPTION selected='selected' VALUE=<?php print $x ?>><?php print $x?></OPTION>
                        ...
                        <?php for($k = 1; $k <= 5; $k+=.5) {
							if ($k == $spiritScores[$i]) { ?>
								<INPUT TYPE='radio' id="spiritStandard" checked name='spiritScore[<?php print $i?>]' VALUE=<?php print $k?> ><span id="spiritStandard"><?php print $k ?></span>
							<?php } else { ?>
								<INPUT TYPE='radio' id="spiritStandard" name='spiritScore[<?php print $i ?>]' VALUE=<?php print $k ?> ><span id="spiritStandard"><?php print $k ?></span>
							<?php }
						} ?>
                        </SELECT>
						</div>
				...
				<div class="Row">
					<div class="left_column" style="vertical-align:middle;">Comments:
					</div>
                    <div class="Cell">
						<TEXTAREA NAME='matchComments[]'  style="width:90%; padding: 5px 0px" ROWS=6><?php print $matchComments[$i]?></TEXTAREA>
					</div>
                </div>
			</div>
            </div>
        		...
        		<div class="Row" align="center">
                    ...
                    <div class="Column">
						<?php if(isValid($submitEmail)) { ?> 
                            <INPUT TYPE='email' NAME='submitemail' style="width:100%;" value='<?php print $submitEmail?>' SIZE=45>
                        <?php } else { ?>
                            <INPUT TYPE='email' NAME='submitemail' style="width:100%;" value='' SIZE=45>
                        <?php } ?>   
                    </div>
                </div>
            </div>  
