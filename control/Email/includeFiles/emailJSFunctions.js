function reloadPage(emailTarget) {
	...
	var emailPage = '';
	if(parseInt(emailTarget) == 1) {
		emailPage = 'emailCaptains.php';
	} else if(parseInt(emailTarget) == 2) {
		emailPage = 'emailTeams.php';
	} else if(parseInt(emailTarget) == 3) {
		emailPage = 'emailPlayers.php';
	} else if(parseInt(emailTarget) == 4) {
		emailPage = 'emailAgents.php';
	}
	
	top.location.href=emailPage+'?sportID='+sportID+'&leagueID='+leagueID+'&dayNumber='+dayNumber+'&seasonID='+seasonID;
