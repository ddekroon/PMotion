...
function getPlayerData($sportID, $leagueID, $dayNumber, $seasonID, $orderBy, $direction) {
	...
	$playersQuery = "SELECT player_id, team_name, player_firstname, player_lastname, player_email, sport_id, league_id, league_name, league_day_number, team_id
...
function getAgentData($sportID, $leagueID, $dayNumber, $seasonID, $orderBy, $direction) {
	...
	$playersQuery = "SELECT player_id, team_name, player_firstname, player_lastname, player_email, sport_id, league_id, league_name, league_day_number, individual_small_group_id
		FROM $playersTable 
...
function getPastTournamentData($tourneyID, $year, $orderBy, $direction) {
	...
	$playersQuery = "SELECT tournament_player_email, tournament_player_team_id, tournament_player_id, tournament_player_firstname, tournament_player_lastname, 
		tournament_player_tournament_id, tournament_player_created_date
