  ...
  return function (dispatch) {
    ...
    return fetch('http://data.perpetualmotion.org/web-app/api/lookups')
      ...
      .then((responseJson) => {
        ...
        let scoreReporterSeasons = parseSeasonsBySport(responseJson.sports, responseJson.seasonsAvailableScoreReporter);
        let registrationSeasons = parseSeasonsBySport(responseJson.sports, responseJson.seasonsAvailableRegistration);
...
const parseSeasonsBySport = (sports, seasons) => {
  ...
  if (typeof (sports) === 'undefined' || typeof (seasons) === 'undefined'
    || sports == null || seasons == null) {
    return [];
  }
