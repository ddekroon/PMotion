...
$sportArray = query("SELECT sport_registration_due_date FROM $sportsTable WHERE sport_id = $sportID");
$registration_dueDB = $sportArray['sport_registration_due_date']; //sets what shows up on the registration form as the due date.
