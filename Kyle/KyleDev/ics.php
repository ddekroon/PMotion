...
class Includes_ICS {
	...
	public static function header_to_string() {
		$rows = array(
				'BEGIN:VCALENDAR',
				'VERSION:2.0',
	...
	public static function footer_to_string() {
		$rows = array('END:VCALENDAR');
		return implode("\r\n", $rows);
	}
	...
	private function format_eventdatetime($dt) {
		return ";TZID=America/Toronto:" . $dt->format(self::DT_FORMAT);
