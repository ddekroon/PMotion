...
/******************************
Writer: Bradley Connolly
Date: July 31st, 2015
Description: In game socre tracker for the user, will send email reminder with the score
*******************************/
...
<html>        
    <head>
       ...
       <!-- This is the javascript file that makes all of the dropdowns and reloads work properly -->
        ...
        <link rel='stylesheet' type='text/css' href='includeFiles/trackStyles3.css'/>
    ...
    <body>
       ...
       <FORM id='trackReporterID' name="trackReporter" method='POST' action=<?php print $_SERVER['PHP_SELF']. '?sportID='. 3 . '&leagueID='. 1345 .'&teamID=' . 4317 ?> 
