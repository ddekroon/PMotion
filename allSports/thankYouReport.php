...
$query = mysql_query("SELECT league_name, league_day_number, team_name
	FROM $teamsTable INNER JOIN $leaguesTable ON $leaguesTable.league_id = $teamsTable.team_league_id WHERE team_id = $teamID");
...
<body>
	...
	<div class="image"><img border="0" src="/Logos/Perpetualmotionlogo2.jpg" width="95%" style="max-width:400px;"></div>
	<div class="container">
